...
class Navigation extends WActiveRecord
{
	...
	/**
	 * Print out the navigation generated by buildNavigation()
	 * @return string based representation of the navigation
	 */
	public static function printNavigation() {
		$ret=Yii::app()->cache->get(Utils::$CACHE_NAVIGATION);
		if($ret===false) {
			...
			$ret .= "</ul>";
			Yii::app()->cache->set(Utils::$CACHE_NAVIGATION, $ret, Utils::$CACHE_DURATION_LONG);
		}
		return $ret;
	}
}