...
class ItemForm extends CWidget
{
	...
	public function run(){
		Yii::app()->clientScript->registerScript('variables_item_form',"
			var stylesheet = '".Yii::app()->createAbsoluteUrl('/css/wysihtml5.css')."';
			var downloadLink = '".CHtml::link("_NAME_", Yii::app()->createAbsoluteUrl('/FileItem/download', array('id'=>'_ID_')))."';", CClientScript::POS_HEAD);
